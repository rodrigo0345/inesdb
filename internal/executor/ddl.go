...
func execCreateTable(db database.Database, stmt *ast.CreateTableStatement) (*Result, error) {
	cols := []schema.Column{}
...
func execDropTable(db database.Database, stmt *ast.DropStatement) (*Result, error) {
