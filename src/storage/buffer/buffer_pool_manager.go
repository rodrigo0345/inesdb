...
import (
	...
	"github.com/rodrigo0345/omag/src/storage/replacer"
...
type BufferPoolManager struct {
	...
	pageTable       map[page.ResourcePageID]replacer.FrameID
...
func NewBufferPoolManagerWithReplacer(
	poolSize int,
	diskManager *DiskManager,
	replacerManager replacer.IReplacer) IBufferPoolManager {
	...
	return &BufferPoolManager{
		poolSize:        poolSize,
		frames:          frames,
		pageTable:       make(map[page.ResourcePageID]replacer.FrameID),
		freeList:        freeList,
		diskManager:     diskManager,
